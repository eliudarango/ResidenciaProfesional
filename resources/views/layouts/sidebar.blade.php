            ...
            <ul class="navbar-item flex-row ms-lg-auto ms-0">
                ...
                <li class="nav-item dropdown language-dropdown">
                    <a href="javascript:void(0);" class="nav-link dropdown-toggle" id="language-dropdown"
                        ...
                        <img src="/Template/src/assets/img/1x1/us.svg" class="flag-width" alt="flag">
                    </a>
                ...
                <li class="nav-item dropdown notification-dropdown">
                    ...
                    <div class="dropdown-menu position-absolute" aria-labelledby="notificationDropdown">
                        ...
                        <div class="notification-scroll">
                            ...
                            <div class="dropdown-item">
                                <div class="media ">
                                    <img src="/Template/src/assets/img/profile-15.jpeg" class="img-fluid me-2"
                                        alt="avatar">
                                    <div class="media-body">
                                        <div class="data-info">
                            ...
                            <div class="dropdown-item">
                                <div class="media file-upload">
                                    <img src="/Template/src/assets/img/profile-21.jpeg" class="img-fluid me-2"
                                        alt="avatar">
                                    <div class="media-body">
                                        <div class="data-info">
            ...
            <div class="footer-wrapper">
                <div class="footer-section f-section-1">
                    <p class="">Copyright © <span class="dynamic-year">2024</span> <a target="_blank"
                            href="https://designreset.com/cork-admin/">Instituto Tecnologico Oaxaca</a>, ITO.</p>
                </div>
